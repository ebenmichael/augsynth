...
```{r ppool_syn_plot_ca, fig.width=8, fig.height=4.5, fig.align="center", warning=F, message=F}
...
```{r wevent_plot_ca, fig.width=8, fig.height=4.5, fig.align="center", warning=F, message=F}
