...
```{r fig_syn_plus, fig.width=8, fig.height=4.5, echo=F, fig.align="center"}
...
```{r fig_asyn_cv, fig.width=8, fig.height=4.5, echo=F, fig.align="center"}
plot(asyn, cv = T)
```
...
```{r fig_covsyn_resid, fig.width=8, fig.height=4.5, echo=F, fig.align="center"}
plot(covsyn_resid)
```
...
```{r fig_desyn, fig.width=8, fig.height=4.5, echo=F, fig.align="center"}
plot(desyn)
```
