...
```{r fig_syn_placebo, fig.width=8, fig.height=4.5, echo=T, fig.align="center"}
...
```{r fig_syn_perm, fig.width=8, fig.height=4.5, echo=T, fig.align="center"}
...
```{r fig_syn_outcomes, fig.width=8, fig.height=4.5, echo=T, fig.align="center"}
...
```{r fig_syn_noinf, fig.width=8, fig.height=4.5, echo=T, fig.align="center"}
plot(asyn, inf = FALSE)
