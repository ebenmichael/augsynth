...
* Add `augsynth_outcomes_plot()`, which shows the outcome trajectory of the treated unit, the synthetic counterfactual, and (optionally) the simple average of donor units.
...
By default, `augsynth_outcomes_plot()` and  `plot(augsynth, plot_type = 'outcommes')` will return both the raw average of donor units and the synthetic counterfactual.
