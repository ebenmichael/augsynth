...
Adding permutation inference (via `inf_type = "permutation"` or `inf_type = "permutation_rstat"`) will return information about the 95% confidence interval, as well as other data generated from the raw placebo tests. Placebo results are stored in `augsynth$results$permutations`
