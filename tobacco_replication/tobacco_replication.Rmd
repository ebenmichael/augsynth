...
By default, `augsynth_outcomes_plot()` and  `plot(augsynth, plot_type = 'outcomes')` will return both the raw average of donor units and the synthetic counterfactual.
